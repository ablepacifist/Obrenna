...
CODEBASE_PROJECT_HINT_TEMPLATE = (
    ...
    "   - Find how the project already connects (a db config/env file, a "
    "connection helper, an existing script). Reuse THOSE credentials and that "
    "connection code — never invent connection strings or ask the user for "
    "passwords.\n"
